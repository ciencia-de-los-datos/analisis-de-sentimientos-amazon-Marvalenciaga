...
def pregunta_03():
    ...
    # Cree una instancia del analizador de palabras (build_analyze)
    vector = CountVectorizer(analyzer="word",token_pattern=r"(?u)\b[a-zA-Z][a-zA-Z]+\b", lowercase=True)
...
def pregunta_04():
    ...
    # BernoulliNB.
    Diccionario = {"bernoulli__alpha": np.arange(0.1, 1.01, 0.1),}
